...
const ShortCutCard: React.FC<ShortCutCardProps> = ({ name, image, link }) => {
  return (
    <Link href={link} className="group">
      <div className="relative h-[150px] w-[300px] overflow-hidden rounded-xl">
        <h3 className="group absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-10 text-white font-bold text-2xl drop-shadow-lg">
          {name}
        </h3>
